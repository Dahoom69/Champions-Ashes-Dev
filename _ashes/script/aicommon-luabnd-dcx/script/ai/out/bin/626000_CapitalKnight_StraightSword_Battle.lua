...
Goal.Activate = function (arg0, arg1, arg2)
	...
	local0[13] = SetCoolTime(arg1, arg2, 3018, 15, local0[13], 0)
	...
	local1[13] = REGIST_FUNC(arg1, arg2, GOAL_626000_CapitalKnight_StraightSword_Act13)
	...
	local1[31] = REGIST_FUNC(arg1, arg2, GOAL_626000_CapitalKnight_StraightSword_Act31)
	...
	local1[39] = REGIST_FUNC(arg1, arg2, GOAL_626000_CapitalKnight_StraightSword_Act39)
...
function GOAL_626000_CapitalKnight_StraightSword_Act03(arg0, arg1, arg2)
    ...
    elseif local9 <= 80 then
		...
		arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3005, TARGET_ENE_0, 4.4, 0, 0)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3026, TARGET_ENE_0, local6, 0, 0)
    else
...
function GOAL_626000_CapitalKnight_StraightSword_Act05(arg0, arg1, arg2)
    ...
    arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, local3, TARGET_ENE_0, local10, 0, 0, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, local6, TARGET_ENE_0, local10, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, local4, TARGET_ENE_0, local10, 0, 0)
...
function GOAL_626000_CapitalKnight_StraightSword_Act11(arg0, arg1, arg2)
	...
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3023, TARGET_ENE_0, 3.9, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3030, TARGET_ENE_0, 999, 0, 0)
	elseif local7 <= 50 then
	arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, 3203, TARGET_ENE_0, 5.1, 0, 0, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3023, TARGET_ENE_0, 3.9, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3024, TARGET_ENE_0, 3.9, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3025, TARGET_ENE_0, 999, 0, 0)
	elseif local7 <= 63 then
	arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, 3203, TARGET_ENE_0, 5.1, 0, 0, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3030, TARGET_ENE_0, local3, 0, 0)
	elseif local7 <= 75 then
    arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, 3027, TARGET_ENE_0, local3, local4, local5, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3028, TARGET_ENE_0, 3.9, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3025, TARGET_ENE_0, local3, 0, 0)
	elseif local7 <= 88 then
	arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, 3024, TARGET_ENE_0, 5.1, 0, 0, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3025, TARGET_ENE_0, 3.9, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3026, TARGET_ENE_0, 999, 0, 0)
	else
	arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, 3024, TARGET_ENE_0, 5.1, 0, 0, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3025, TARGET_ENE_0, 3.9, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3030, TARGET_ENE_0, local3, 0, 0)
...
function GOAL_626000_CapitalKnight_StraightSword_Act12(arg0, arg1, arg2)
	...
	local local20 = arg0:GetRandam_Int(1, 100)
    if local20 <= 50 then
	arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, 3204, TARGET_ENE_0, 5.1, 0, 0, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3029, TARGET_ENE_0, 3.9, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3026, TARGET_ENE_0, local3, 0, 0)
	elseif local20 <= 60 then
	arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, 3204, TARGET_ENE_0, 5.1, 0, 0, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3029, TARGET_ENE_0, 3.9, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3030, TARGET_ENE_0, local3, 0, 0)
	else
    arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, 3204, TARGET_ENE_0, local3, local4, local5, 0, 0)
    end
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end

function GOAL_626000_CapitalKnight_StraightSword_Act13(arg0, arg1, arg2)
    local local0 = 4
    local local1 = local0 + 2
    local local2 = local0 + 4
    if not arg0:HasSpecialEffectId(TARGET_SELF, 5020) then
    ...
    Approach_Act_Flex(arg0, arg1, local0, local1, local2, 40, 0, 3, 6)
    local local3 = arg0:GetRandam_Int(1, 100)
    arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, 3018, TARGET_ENE_0, 999, 0, 0, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end
...
function GOAL_626000_CapitalKnight_StraightSword_Act18(arg0, arg1, arg2)
	...
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3009, TARGET_ENE_0, local10, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3010, TARGET_ENE_0, 999, 0, 0)
	else
	arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3011, TARGET_ENE_0, local10, 0, 0, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3014, TARGET_ENE_0, local10, 0, 0)
...
function GOAL_626000_CapitalKnight_StraightSword_Act31(arg0, arg1, arg2)
    local local0 = 4.8
    local local1 = local0 + 2
    local local2 = local0 + 4
    local local3 = 40
    ...
    arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, 3024, TARGET_ENE_0, local3, local4, local5, 0, 0)
    end
	GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end
...
function GOAL_626000_CapitalKnight_StraightSword_Act39(arg0, arg1, arg2)
    local local0 = 4.8
    local local1 = local0 + 2
    local local2 = local0 + 4
    local local3 = 40
    ...
    local local7 = arg0:GetRandam_Int(1, 100)
    local local8 = arg0:GetDist(TARGET_ENE_0)
    arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, 3027, TARGET_ENE_0, 5, 0, 0, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3028, TARGET_ENE_0, 3.9, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3025, TARGET_ENE_0, 999, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
Goal.Interrupt = function (arg0, arg1, arg2)
	...
	if arg1:IsInterupt(INTERUPT_FindAttack) and loca12 <= 80 and arg1:HasSpecialEffectId(TARGET_SELF, 5821) and local0 <= 4.5 then
        arg2:ClearSubGoal()
        GOAL_626000_CapitalKnight_StraightSword_Act31(arg1, arg2, paramTbl)
        arg2:AddSubGoal(GOAL_626000_CapitalKnight_StraightSword_AfterAttackAct, 10)
    end
	if arg1:IsInterupt(INTERUPT_FindAttack) and loca12 <= 90 and arg1:HasSpecialEffectId(TARGET_SELF, 5821) and local0 <= 4.5 then
        arg2:ClearSubGoal()
        GOAL_626000_CapitalKnight_StraightSword_Act39(arg1, arg2, paramTbl)
        arg2:AddSubGoal(GOAL_626000_CapitalKnight_StraightSword_AfterAttackAct, 10)
    end
