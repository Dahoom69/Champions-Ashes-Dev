...
Goal.Activate = function (arg0, arg1, arg2)
	...
	local0[15] = SetCoolTime(arg1, arg2, 3013, 5, local0[15], 0)
	...
	local1[15] = REGIST_FUNC(arg1, arg2, SpearSilverKnight_Act15)
...
function SpearSilverKnight_Act05(arg0, arg1, arg2)
    ...
    elseif local12 <= 75 then
        ...
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, local0, TARGET_ENE_0, local6, local10, local11)
        arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3015, TARGET_ENE_0, local7)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3016, TARGET_ENE_0, local5)
    end
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end
...
function SpearSilverKnight_Act09(arg0, arg1, arg2)
    ...
    local local9 = arg0:GetRandam_Int(1, 100)
    if local9 <= 50 then
        local local0 = arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, local0, TARGET_ENE_0, 13 - arg0:GetMapHitRadius(TARGET_SELF) + 1, 0, 0)
        local0:TimingSetNumber(1, 1, AI_TIMING_SET__ACTIVATE)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, local1, TARGET_ENE_0, 5 - arg0:GetMapHitRadius(TARGET_SELF))
    else
        local local0 = arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, local0, TARGET_ENE_0, 13 - arg0:GetMapHitRadius(TARGET_SELF) + 1, 0, 0)
        local0:TimingSetNumber(1, 1, AI_TIMING_SET__ACTIVATE)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, local2, TARGET_ENE_0, 5 - arg0:GetMapHitRadius(TARGET_SELF))
    end
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end
...
function SpearSilverKnight_Act11(arg0, arg1, arg2)
    ...
    local local9 = arg0:GetRandam_Int(1, 100)
    if local9 <= 15 then
        local local10 = arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, local0, TARGET_ENE_0, 5.2 - arg0:GetMapHitRadius(TARGET_SELF) + 1, 0, 0)
        local10:TimingSetNumber(1, 1, AI_TIMING_SET__ACTIVATE)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, local1, TARGET_ENE_0, 5 - arg0:GetMapHitRadius(TARGET_SELF))
	...
	elseif local9 <= 80 then
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, local0, TARGET_ENE_0, local5, local7, local8)
        arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, local2, TARGET_ENE_0, 5.9 - arg0:GetMapHitRadius(TARGET_SELF) + 1)
        local local10 = arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, local3, TARGET_ENE_0, local6)
        local10:TimingSetNumber(1, 1, AI_TIMING_SET__ACTIVATE)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, local1, TARGET_ENE_0, local4)
	else
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, local0, TARGET_ENE_0, DistToAtt5, local7, local8)
        local local10 = arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, local2, TARGET_ENE_0, local6)
        local10:TimingSetNumber(1, 1, AI_TIMING_SET__ACTIVATE)
		arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, local0, TARGET_ENE_0, local7)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, local1, TARGET_ENE_0, local4)
    end
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
...
function SpearSilverKnight_Act15(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 5.2 - arg0:GetMapHitRadius(TARGET_SELF), 5.2 - arg0:GetMapHitRadius(TARGET_SELF) + 1, 5.2 - arg0:GetMapHitRadius(TARGET_SELF) + 1, 0, 80, 5, 5)
    local local0 = 3013
    local local1 = 3020
    local local2 = 3007
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if arg1:IsInterupt(INTERUPT_SuccessGuard) and InsideRange(arg1, arg2, 0, 180, -99, 4) and arg1:GetRandam_Int(1, 100) <= 80 then
		...
		elseif local2 <= 85 then
            arg2:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3017, TARGET_ENE_0, local7, local10, local11)
            arg2:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3007, TARGET_ENE_0, local6)
            arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3018, TARGET_ENE_0, local5)
        else
