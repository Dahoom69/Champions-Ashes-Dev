...
function ArcherSilverKnight_Act01(arg0, arg1, arg2)
    ...
    elseif arg0:GetRandam_Int(1, 100) <= 35 then
		...
		arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, local5, TARGET_ENE_0, local7, local10, local11)
        arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, local5, TARGET_ENE_0, local6)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, local5, TARGET_ENE_0, local5)
    end
...
function ArcherSilverKnight_Act02(arg0, arg1, arg2)
	...
	arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 4, 3001, TARGET_ENE_0, 5.4 - arg1:GetMapHitRadius(TARGET_SELF) + 1, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 4, 3001, TARGET_ENE_0, 5.4 - arg1:GetMapHitRadius(TARGET_SELF) + 1)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 4, 3002, TARGET_ENE_0, 5 - arg1:GetMapHitRadius(TARGET_SELF))
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end
