...
Goal.Activate = function (_, actor, goals)
    ...
    if actor:HasSpecialEffectId(TARGET_SELF, 5404) == false then
        if InsideRange(actor, goals, 0, 180, 48, 75) then
            probabilities[5] = 10
        elseif InsideRange(actor, goals, 45, 90, 25, 48) then
            probabilities[1] = 10
        elseif InsideRange(actor, goals, -45, 90, 25, 48) then
            probabilities[2] = 10
        elseif InsideRange(actor, goals, 0, 90, 5, 25) then
            probabilities[3] = 20
            probabilities[4] = 10
        elseif InsideRange(actor, goals, 0, 180, -99, 5) then
            probabilities[32] = 10
        else
            probabilities[32] = 10
        end
