...
Goal.Activate = function (arg0, arg1, arg2)
	...
	local0[10] = SetCoolTime(arg1, arg2, 3024, 15, local0[10], 0)
	...
	local1[10] = REGIST_FUNC(arg1, arg2, GOAL_626000_CapitalKnight_DualUltraGreatsword_Act10)
...
function GOAL_626000_CapitalKnight_DualUltraGreatsword_Act02(arg0, arg1, arg2)
    ...
    if 3.5 <= arg0:GetDist(TARGET_ENE_0) then
		...
		arg1:AddSubGoal(GOAL_COMMON_ComboRepeat_SuccessAngle180, 10, local4, TARGET_ENE_0, 5.5, 0, 0)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, local5, TARGET_ENE_0, local8, 0, 0)
...
function GOAL_626000_CapitalKnight_DualUltraGreatsword_Act04(arg0, arg1, arg2)
	...
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat_SuccessAngle180, 10, 3016, TARGET_ENE_0, 5.5, 0, 0)
...
function GOAL_626000_CapitalKnight_DualUltraGreatsword_Act05(arg0, arg1, arg2)
	...
	elseif arg0:GetRandam_Int(1, 100) <= 70 then
        ...
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, local0, TARGET_ENE_0, 5.5, local2, local3, 0, 0)
		arg1:AddSubGoal(GOAL_COMMON_ComboRepeat_SuccessAngle180, 10, 3012, TARGET_ENE_0, 5.5, 0, 0)
...
function GOAL_626000_CapitalKnight_DualUltraGreatsword_Act10(arg0, arg1, arg2)
    local local0 = 7.4
    local local1 = local0 + 5
    local local2 = local0 + 10
    if not arg0:HasSpecialEffectId(TARGET_SELF, 5020) then
    ...
    Approach_Act_Flex(arg0, arg1, local0, local1, local2, 70, 0, 3, 6)
    local local3 = arg0:GetRandam_Int(1, 100)
    arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3024, TARGET_ENE_0, 5.8 + 1, 0, 0, 0, 0)
