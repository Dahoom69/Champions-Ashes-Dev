...
function GOAL_626000_CapitalKnight_Spear_Act02(arg0, arg1, arg2)
    ...
    if local12 <= 70 then
	arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, local6, TARGET_ENE_0, 5.1, 0, 0, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, local7, TARGET_ENE_0, 3.9, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3014, TARGET_ENE_0, 999, 0, 0)
	elseif local12 <= 80 then
	arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, local6, TARGET_ENE_0, 5.1, 0, 0, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, local7, TARGET_ENE_0, 3.9, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3014, TARGET_ENE_0, 3.9, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, local7, TARGET_ENE_0, 999, 0, 0)
	else
	arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, local6, TARGET_ENE_0, 5.1, 0, 0, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, local7, TARGET_ENE_0, 3.9, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3014, TARGET_ENE_0, 3.9, 0, 0)
...
function GOAL_626000_CapitalKnight_Spear_Act03(arg0, arg1, arg2)
	...
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3013, TARGET_ENE_0, 5.1, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3008, TARGET_ENE_0, 5.1, 0, 0)
	else
    arg1:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, 3012, TARGET_ENE_0, 999, 0, 0, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3013, TARGET_ENE_0, 5.1, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3014, TARGET_ENE_0, 5.1, 0, 0)
	end
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end
...
function GOAL_626000_CapitalKnight_Spear_Act11(arg0, arg1, arg2)
	...
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3007, TARGET_ENE_0, 3.9, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3014, TARGET_ENE_0, 999, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end
...
function GOAL_626000_CapitalKnight_Spear_Act12(arg0, arg1, arg2)
	...
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3014, TARGET_ENE_0, 3.9, 0, 0)
	arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3007, TARGET_ENE_0, 3.9, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3009, TARGET_ENE_0, 999, 0, 0)
	end
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) then
        ...
        elseif arg1:GetSpecialEffectActivateInterruptType(0) == 5028 and local0 <= 7.1 + 1 then
            ...
            arg2:AddSubGoal(GOAL_626000_CapitalKnight_Spear_AfterAttackAct, 10)
            return true
		elseif arg1:GetSpecialEffectActivateInterruptType(0) == 5029 and arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 360) and arg1:HasSpecialEffectId(TARGET_SELF, 16269) and local0 <= 4.8 + 1 then
            local local5 = 3009
            if arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 240) then
                local5 = 3009
            end
            ...
            arg2:AddSubGoal(GOAL_626000_CapitalKnight_Spear_AfterAttackAct, 10)
            return true
		elseif arg1:GetSpecialEffectActivateInterruptType(0) == 5030 and arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 360) and arg1:HasSpecialEffectId(TARGET_SELF, 16269) and local0 <= 4.8 + 1 then
            local local5 = 3017
            if arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 240) then
                local5 = 3017
            end
            ...
            arg2:AddSubGoal(GOAL_626000_CapitalKnight_Spear_AfterAttackAct, 10)
            return true
		elseif arg1:GetSpecialEffectActivateInterruptType(0) == 5031 and arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 360) and arg1:HasSpecialEffectId(TARGET_SELF, 16269) and local0 <= 4.8 + 1 then
            local local5 = 3021
            if arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 240) then
                local5 = 3021
            end
            ...
            arg2:AddSubGoal(GOAL_626000_CapitalKnight_Spear_AfterAttackAct, 10)
            return true
		elseif arg1:GetSpecialEffectActivateInterruptType(0) == 5032 and arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 360) and arg1:HasSpecialEffectId(TARGET_SELF, 16269) and local0 <= 4.8 + 1 then
            local local5 = 3014
            if arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 240) then
                local5 = 3014
            end
