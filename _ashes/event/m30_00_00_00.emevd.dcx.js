...
$Event(0, Default, function() {
    RegisterBonfire(13000009, 3001950, 5, 180, 0);
    RegisterBonfire(13000003, 3001959, 5, 180, 0);
    RegisterBonfire(13000005, 3001955, 5, 180, 0);
    RegisterBonfire(13000008, 3001958, 5, 180, 0);
    InitializeCommonEvent(20005500, 13000830, 13000001, 3000951, 3001951);
    InitializeCommonEvent(20005500, 13000890, 13000004, 3000954, 3001954);
    InitializeEvent(0, 13000210, 0);
    InitializeEvent(0, 13000200, 0);
    InitializeCommonEvent(20005780, 3001780, 2);
    InitializeEvent(0, 13005350, 3001890, 3);
    InitializeEvent(0, 13005810, 0);
    InitializeEvent(0, 13005811, 0);
    InitializeEvent(0, 13005815, 0);
    InitializeEvent(0, 13005820, 0);
    ...
    InitializeEvent(0, 13005840, 0);
    InitializeEvent(0, 13005835, 0);
    InitializeEvent(0, 13005836, 0);
    InitializeEvent(0, 13005837, 0);
    InitializeEvent(0, 13005838, 0);
    InitializeEvent(0, 13005595, 0);
    InitializeEvent(0, 13005850, 0);
    InitializeEvent(0, 13005890, 0);
    ...
    InitializeCommonEvent(20005840, 3001890);
    InitializeCommonEvent(20005841, 3001890);
    InitializeEvent(0, 13005280, 3001316, 830078);
    InitializeEvent(1, 13005280, 3001300, 830077);
    InitializeEvent(2, 13005280, 3001301, 830077);
    InitializeEvent(3, 13005280, 3001302, 830077);
    InitializeEvent(4, 13005280, 3001303, 830077);
    InitializeEvent(5, 13005280, 3001304, 830077);
    InitializeEvent(6, 13005280, 3001305, 830077);
    InitializeEvent(7, 13005280, 3001306, 830077);
    InitializeEvent(8, 13005280, 3001307, 830077);
    InitializeEvent(9, 13005280, 3001308, 830077);
    InitializeEvent(10, 13005280, 3001309, 830077);
    InitializeEvent(11, 13005280, 3001310, 830077);
    InitializeEvent(12, 13005280, 3001311, 830077);
    InitializeEvent(13, 13005280, 3001312, 830077);
    InitializeEvent(14, 13005280, 3001313, 830077);
    InitializeEvent(15, 13005280, 3001314, 830077);
    InitializeEvent(16, 13005280, 3001315, 830077);
    ...
    InitializeCommonEvent(20005417, 13001501, 3000612, 3000613, 702, 1702, 0, 13005503, 13005504, 3002365);
    InitializeEvent(0, 13005510, 3000610, 3000502, 20000, 1045220557);
    InitializeEvent(1, 13005510, 3000610, 3000509, 20001, 0);
    InitializeEvent(2, 13005510, 3000610, 3000505, 20002, 1060320051);
    InitializeEvent(3, 13005510, 3000610, 3000507, 20000, 1065353216);
    InitializeEvent(4, 13005510, 3000612, 3000423, 20000, 0);
    InitializeEvent(5, 13005510, 3000612, 3000421, 20000, 1045220557);
    InitializeEvent(6, 13005510, 3000612, 3000410, 20001, 1053609165);
    InitializeEvent(7, 13005510, 3000612, 3000411, 20002, 1058642330);
    ...
    InitializeEvent(0, 13005240, 3000590, 20000, 0, 3000590, 3000591, 3000592, 3000593, 3000594, 3000595, 3000596, 3000597, 3000598);
    InitializeEvent(1, 13005240, 3000591, 20001, 0, 3000590, 3000591, 3000592, 3000593, 3000594, 3000595, 3000596, 3000597, 3000598);
    InitializeEvent(2, 13005240, 3000592, 20002, 0, 3000590, 3000591, 3000592, 3000593, 3000594, 3000595, 3000596, 3000597, 3000598);
    InitializeEvent(3, 13005240, 3000593, 20000, 0, 3000590, 3000591, 3000592, 3000593, 3000594, 3000595, 3000596, 3000597, 3000598);
    InitializeEvent(4, 13005240, 3000594, 20001, 0, 3000590, 3000591, 3000592, 3000593, 3000594, 3000595, 3000596, 3000597, 3000598);
    InitializeEvent(5, 13005240, 3000595, 20002, 0, 3000590, 3000591, 3000592, 3000593, 3000594, 3000595, 3000596, 3000597, 3000598);
    InitializeEvent(6, 13005240, 3000596, 20000, 0, 3000590, 3000591, 3000592, 3000593, 3000594, 3000595, 3000596, 3000597, 3000598);
    InitializeEvent(7, 13005240, 3000597, 20001, 0, 3000590, 3000591, 3000592, 3000593, 3000594, 3000595, 3000596, 3000597, 3000598);
    InitializeEvent(8, 13005240, 3000598, 20002, 0, 3000590, 3000591, 3000592, 3000593, 3000594, 3000595, 3000596, 3000597, 3000598);
    InitializeEvent(0, 13005025, 0);
    InitializeEvent(0, 13005530, 0);
    InitializeEvent(0, 13005535, 0);
    InitializeCommonEvent(20005119, 3000230, 3002350, 3002221, 0, 0, 0, 0, 0);
    InitializeCommonEvent(20005119, 3000237, 3002222, 3002225, 0, 0, 0, 0, 0);
    InitializeCommonEvent(20005350, 3000238, 12800420, 53010980);
    InitializeCommonEvent(20005119, 3000254, 3002226, 3002221, 0, 0, 0, 0, 0);
    InitializeCommonEvent(20005110, 3000255, 3002360);
    InitializeCommonEvent(20005224, 3000280, 701, 1701);
    InitializeCommonEvent(20005224, 3000281, 701, 1701);
    InitializeCommonEvent(20005119, 3000300, 3002226, 3002221, 0, 0, 0, 0, 0);
    InitializeCommonEvent(20005220, 3000350, 702, 1702);
    InitializeCommonEvent(20005224, 3000351, 702, 1702);
    InitializeCommonEvent(20005350, 3000352, 11901120, 53010955);
    InitializeCommonEvent(20005202, 3000360, 701, 1701, 3002655);
    InitializeCommonEvent(20005202, 3000361, 701, 1701, 3002655);
    InitializeCommonEvent(20005210, 3000409, 706, 1706, 1077936128);
    InitializeCommonEvent(20005290, 3000410, 701, 1701);
    InitializeCommonEvent(20005290, 3000411, 702, 1702);
    ...
    InitializeCommonEvent(20005290, 3000421, 700, 1700);
    InitializeCommonEvent(20005290, 3000423, 700, 1700);
    InitializeCommonEvent(20005110, 3000424, 3002224);
    InitializeCommonEvent(20005110, 3000425, 3002224);
    InitializeCommonEvent(20005290, 3000426, 705, 1705);
    InitializeCommonEvent(20005110, 3000427, 3002341);
    InitializeCommonEvent(20005220, 3000430, 703, 1703);
    InitializeCommonEvent(20005122, 3000431, 3003, 1086324736);
    ...
    InitializeCommonEvent(20005290, 3000450, 700, 1700);
    InitializeCommonEvent(20005290, 3000451, 701, 1701);
    InitializeCommonEvent(20005290, 3000452, 702, 1702);
    InitializeCommonEvent(20005290, 3000454, 701, 1701);
    InitializeCommonEvent(20005290, 3000456, 700, 1700);
    InitializeCommonEvent(20005290, 3000457, 701, 1701);
    InitializeCommonEvent(20005110, 3000443, 3002340);
    InitializeCommonEvent(20005290, 3000463, 701, 1701);
    InitializeCommonEvent(20005290, 3000464, 702, 1702);
    InitializeCommonEvent(20005192, 3000471, 3002441);
    InitializeCommonEvent(20005290, 3000473, 700, 1700);
    InitializeCommonEvent(20005205, 3000477, 710, 1710, 3002361, 1066192077);
    InitializeCommonEvent(20005205, 3000478, 710, 1710, 3002361, 1065353216);
    InitializeCommonEvent(20005119, 3000482, 3002226, 3002221, 0, 0, 0, 0, 0);
    InitializeCommonEvent(20005110, 3000483, 3002340);
    InitializeCommonEvent(20005290, 3000484, 702, 1702);
    InitializeCommonEvent(20005290, 3000486, 701, 1701);
    InitializeCommonEvent(20005290, 3000487, 702, 1702);
    ...
    InitializeCommonEvent(20005210, 3000496, 710, 1710, 1083179008);
    InitializeCommonEvent(20005290, 3000500, 703, 1703);
    InitializeCommonEvent(20005290, 3000502, 700, 1700);
    InitializeCommonEvent(20005290, 3000504, 702, 1702);
    InitializeCommonEvent(20005290, 3000505, 702, 1702);
    InitializeCommonEvent(20005290, 3000507, 700, 1700);
    InitializeCommonEvent(20005290, 3000509, 701, 1701);
    InitializeCommonEvent(20005122, 3000511, 3000, 1084227584);
    InitializeCommonEvent(20005210, 3000520, 706, 1706, 1085276160);
    InitializeCommonEvent(20005202, 3000522, 710, 1710, 3002430);
    InitializeCommonEvent(20005111, 3000523, 3003, 3002220);
    InitializeCommonEvent(20005210, 3000525, 706, 1706, 1084227584);
    InitializeCommonEvent(20005210, 3000526, 710, 1710, 1084227584);
    InitializeCommonEvent(20005290, 3000533, 701, 1701);
    ...
    InitializeCommonEvent(20005213, 3000545, 703, 1703, 1077936128, 3002362);
    InitializeCommonEvent(20005290, 3000551, 703, 1703);
    InitializeCommonEvent(20005290, 3000560, 703, 1703);
    ...
    InitializeCommonEvent(20005290, 3000590, 700, 1700);
    InitializeCommonEvent(20005290, 3000591, 700, 1700);
    InitializeCommonEvent(20005290, 3000592, 700, 1700);
    InitializeCommonEvent(20005290, 3000593, 700, 1700);
    InitializeCommonEvent(20005290, 3000594, 700, 1700);
    InitializeCommonEvent(20005290, 3000595, 700, 1700);
    InitializeCommonEvent(20005290, 3000596, 702, 1702);
    InitializeCommonEvent(20005290, 3000597, 700, 1700);
    InitializeCommonEvent(20005290, 3000598, 700, 1700);
    InitializeCommonEvent(20005290, 3000600, 700, 1700);
    InitializeCommonEvent(20005290, 3000601, 701, 1701);
    InitializeCommonEvent(20005290, 3000604, 701, 1701);
    InitializeCommonEvent(20005290, 3000605, 702, 1702);
    InitializeCommonEvent(20005290, 3000607, 701, 1701);
    ...
    InitializeCommonEvent(20005400, 3000620);
    InitializeCommonEvent(20000343, 13000358, 3000620, 53000960);
    InitializeCommonEvent(20005341, 13000359, 3000630, 21500000);
    ...
    InitializeCommonEvent(20005410, 3000400, 3005);
    InitializeCommonEvent(20005411, 3000400, 3000401, 703, 1703, 1076677837);
    InitializeCommonEvent(20005411, 3000400, 3000402, 705, 1705, 1069547520);
    InitializeCommonEvent(20005411, 3000400, 3000403, 706, 1706, 1065353216);
    InitializeCommonEvent(20005411, 3000400, 3000405, 703, 1703, 1074161254);
    InitializeCommonEvent(20005411, 3000400, 3000406, 703, 1703, 1075838976);
    InitializeEvent(0, 13000380, 3000660, 60940, 6780);
    InitializeCommonEvent(20005340, 13000381, 3000661);
    InitializeCommonEvent(20005701, 13000800, 13005700, 13005701, 3000190, 3002780, 13005392, $LAYERS(0, 1, 2, 3, 4, 5, 6, 7, 8));
    InitializeEvent(0, 13005826, 13005700, 13005805, 13005885, 3000190, 3002800, 3002896, 3002820, 3002870, 13000801, 13000896, $LAYERS(0, 1, 2, 3, 4, 5, 6, 7, 8));
    InitializeCommonEvent(20005720, 13005700, 13005701, 13000800, 3000190);
    InitializeCommonEvent(20005714, 13005700, 13005805, 3000190, 3002829, 13000801);
    InitializeEvent(0, 13005390, 0);
    InitializeEvent(0, 13005391, 0);
    InitializeCommonEvent(20005701, 13000800, 13005705, 13005706, 3000191, 3002781, 9500, $LAYERS(0, 1, 2, 3, 4, 5, 6, 7, 8));
    InitializeEvent(1, 13005826, 13005705, 13005805, 13005885, 3000191, 3002800, 3002896, 3002820, 3002870, 13000801, 13000896, $LAYERS(0, 1, 2, 3, 4, 5, 6, 7, 8));
    InitializeCommonEvent(20005720, 13005705, 13005706, 13000800, 3000191);
    InitializeCommonEvent(20005714, 13005705, 13005805, 3000191, 3002829, 13000801);
    InitializeCommonEvent(20005701, 13000830, 13005710, 13005711, 3000192, 3002783, 70000007);
    InitializeCommonEvent(20005710, 13005710, 13005855, 3000192, 3002831, 3002840);
    InitializeCommonEvent(20005720, 13005710, 13005711, 13000830, 3000192);
    InitializeCommonEvent(20005520, 13000350, 3001350, 3004350);
    InitializeCommonEvent(20005520, 13000351, 3001351, 3004351);
    InitializeCommonEvent(20005520, 13000352, 3001352, 3004352);
    InitializeCommonEvent(20005520, 13000353, 3001353, 3004353);
    ...
    InitializeCommonEvent(20005650, 13000990, 3001550);
    ...
    InitializeCommonEvent(20005611, 13000451, 3003302, 3001400, 300320);
    
    InitializeCommonEvent(20005610, 13004008, 3009451, 3009452);
    InitializeCommonEvent(20005611, 13004008, 3009188, 3009187, 300320); //New door shortcut
    
    InitializeCommonEvent(20005610, 13000452, 3002471, 3002470);
    InitializeCommonEvent(20005611, 13000452, 3003304, 3001412, 300310);
    InitializeCommonEvent(20005611, 13000453, 3003303, 3001411, 300312);
    InitializeCommonEvent(20005613, 13000405, 3003309, 3001413, -1, 10010861);
    InitializeCommonEvent(20005613, 13000406, 3003310, 3001415, 300313, 10010870);
    ...
    InitializeCommonEvent(20005540, 13005630, 3001510, 200, 5110, 1056964608, 0, 1065353216);
    InitializeCommonEvent(20005540, 13005631, 3001511, 200, 5110, 1056964608, 0, 1065353216);
    InitializeCommonEvent(20005540, 13005632, 3001512, 200, 5110, 1056964608, 0, 1065353216);
    InitializeCommonEvent(20005540, 13005633, 3001513, 200, 5110, 1056964608, 0, 1065353216);
    RegisterLadder(13000250, 13000251, 3001080);
    RegisterLadder(13000252, 13000253, 3001081);
    //RegisterLadder(13000254, 13000255, 3001082);
    RegisterLadder(13000256, 13000257, 3001083);
    RegisterLadder(13000258, 13000259, 3001084);
    RegisterLadder(13000260, 13000261, 3001085);
    RegisterLadder(13000262, 13000263, 3001086);
    RegisterLadder(13001987, 13001988, 3001987);
    InitializeEvent(0, 13000230, 0);
    InitializeCommonEvent(20005523, 3001270, 1);
    InitializeCommonEvent(20005523, 3001271, 1);
    InitializeCommonEvent(20005523, 3001272, 2);
    InitializeCommonEvent(20005523, 3001273, 2);
    InitializeCommonEvent(20006003, 3000700, 73000132, 1215, 1200, 1201, 1200, 1214);
    InitializeCommonEvent(20006002, 3000700, 1218, 1215, 1219);
    InitializeCommonEvent(20006000, 3000700, 1216, 1217, 73000130, 1059481190, 1215, 1219, 0);
    InitializeCommonEvent(20006001, 3000700, 1216, 1217, 73000130, 3);
    InitializeEvent(0, 13005601, 73000181);
    InitializeEvent(0, 13005602, 3000705, 73000180);
    InitializeEvent(0, 13005603, 3000705);
    InitializeCommonEvent(20006002, 3000705, 1438, 1435, 1439);
    InitializeEvent(0, 13005604, 0);
    InitializeEvent(0, 13005560, 0);
    InitializeEvent(0, 13000360, 0);
    InitializeEvent(0, 13000901, 3001900);
    InitializeCommonEvent(20005210, 3000610, 702, 20002, 1077936128);
    InitializeCommonEvent(20005523, 3002514, 1);
    InitializeCommonEvent(20005523, 3000515, 1);
    InitializeCommonEvent(20005750, 13000800, 13002514, 13004114, 13005114, 3002514, 3002512, 3002513, 1073741824, 0);
    InitializeCommonEvent(20005721, 13004114, 13005114, 13000800, 3002514);
    ...
    InitializeEvent(0, 13009997, 0);
    InitializeEvent(0, 13009996, 0);
    InitializeEvent(0, 13009995, 0);
    InitializeEvent(0, 13009994, 0);
    InitializeEvent(0, 13009993, 3000803);
    InitializeEvent(1, 13009993, 3000804);
    InitializeEvent(0, 13009992, 3080801);
    InitializeEvent(1, 13009992, 3080802);
    InitializeEvent(2, 13009992, 3080803);
    InitializeEvent(0, 13009991, 0);
    InitializeEvent(0, 13009990, 0);
    InitializeEvent(0, 13009989, 0);
    InitializeEvent(0, 13009988, 0);
...
$Event(50, Default, function() {
    ...
    SetMultiplayerdependentBuffsNonboss(3000850, Enabled);
    InitializeEvent(0, 13005620, 3000700);
    InitializeEvent(0, 13005600, 3000705, 3001875, 3001876);
...
$Event(13009209, Restart, function() {
    if (ThisEventSlot()) {
        ChangeCharacterEnableState(3000303, Disabled);
        ForceCharacterDeath(3000303, false);
        ChangeCharacterEnableState(3000302, Disabled);
        ForceCharacterDeath(3000302, false);
        EndEvent();
    }
L0:
    DeactivateObject(3001950, Disabled);
    ChangeCharacterEnableState(3000950, Disabled);
    WaitFor(CharacterDead(3000303));
    SpawnOneshotSFX(TargetEntityType.Object, 3001950, 200, 1060);
...
$Event(13009519, Restart, function() {
    EndIf(PlayerIsNotInOwnWorld());
    if (!EventFlag(73000382)) {
        SetEventFlag(73000382, ON);
        EndEvent();
    }
L0:
    SetEventFlag(73000381, ON);
});

$Event(13009999, Restart, function() {
    if (EventFlag(13000989)) {
        ChangeCharacterEnableState(3000802, Disabled);
        ChangeCharacterEnableState(3000803, Disabled);
        ChangeCharacterEnableState(3000804, Disabled);
        ChangeCharacterEnableState(3000805, Disabled);
        ForceCharacterDeath(3000802, false);
        ForceCharacterDeath(3000803, false);
        ForceCharacterDeath(3000804, false);
        ForceCharacterDeath(3000805, false);
        DeactivateObject(3001001, Disabled);
        DeactivateObject(3001002, Disabled);
        EndEvent();
    }
L0:
    SetCharacterImmortality(3000705, Enabled);
    if (!EventFlag(13000980)) {
        if (!EventFlag(13005981)) {
            WaitFor(CharacterDamagedBy(3000802, 10000) || CharacterDamagedBy(3000705, 10000));
            if (!EventFlag(13005981)) {
                ForceAnimationPlayback(3000802, 1703, false, true, false, 0, 1);
                WaitFor(CharacterDamagedBy(3000802, 10000) || CharacterDamagedBy(3000705, 10000));
            }
        }
        SetEventFlag(13000980, ON);
        SetEventFlag(13005980, ON);
        SetCharacterTeamType(3000802, TeamType.Enemy);
        SetCharacterInvincibility(3000802, Enabled);
        SetCharacterInvincibility(3000705, Enabled);
        SetCharacterHPBarDisplay(3000705, Disabled);
        DisplayStatusMessage(10010681, Enabled);
        SetSpEffect(3000802, 10800);
        DisplayBossHealthBar(Enabled, 3000802, 0, 901283);
        WaitFixedTimeSeconds(5);
        SetCharacterInvincibility(3000802, Disabled);
        EndEvent();
    }
L1:
    SetEventFlag(13005982, ON);
    ChangeCharacterEnableState(3000805, Disabled);
    ForceCharacterDeath(3000805, false);
    WaitFor(InArea(10000, 3002896));
    SetCharacterInvincibility(3000705, Enabled);
    SetCharacterHPBarDisplay(3000705, Disabled);
    SetCharacterTeamType(3000802, TeamType.Enemy);
    SetSpEffect(3000802, 10800);
...
$Event(13009998, Restart, function() {
    EndIf(EventFlag(13000989));
    WaitFor(HPRatio(3000802) <= 0.05);
    WaitFixedTimeSeconds(2);
    PlaySE(3000802, SoundType.s_SFX, 777777777);
    WaitFor(CharacterDead(3000802));
    WaitFixedTimeSeconds(4);
    HandleBossDefeat(3000802);
    SetEventFlag(13000989, ON);
    SetEventFlag(13000988, ON);
    SetCharacterImmortality(3000705, Disabled);
    SetCharacterInvincibility(3000705, Disabled);
    ForceCharacterDeath(3000705, true);
    DestroyObject(3001001);
    DestroyObject(3001002);
    DisplayBossHealthBar(Disabled, 3000802, 0, 901283);
    ChangeCharacterEnableState(3000802, Disabled);
    AwardItemLot(60950);
});

$Event(13009997, Restart, function() {
    WaitFor(EventFlag(13700850));
    SetEventFlag(13000989, ON);
});

$Event(13009996, Restart, function() {
    SetMapSoundState(3070980, Disabled);
    EndIf(EventFlag(13000989));
    WaitFor(EventFlag(13005980));
    EnableBossMapSound(3070980, Enabled);
    WaitFor(EventFlag(13000989));
L0:
    EnableBossMapSound(-1, Disabled);
});

$Event(13009995, Restart, function() {
    InitializeCommonEvent(20005800, 13000989, 3080800, 3002896, 13005955, 8502, 3000802, 13000980, 0);
    InitializeCommonEvent(20005801, 13000989, 3080800, 3002896, 13005955, 8502, 13005956);
    InitializeCommonEvent(20005820, 13000989, 3080800, 3, 13000980);
});

$Event(13009994, Restart, function() {
    EndIf(EventFlag(13000989));
    WaitFor(HPRatio(3000705) <= 0.5);
    SetEventFlag(13005981, ON);
});

$Event(13009993, Restart, function(X0_4) {
    ChangeCharacterEnableState(X0_4, Disabled);
    EndIf(EventFlag(13000989));
    WaitFor(EventFlag(13005980));
    WaitFixedTimeSeconds(4.3);
    ChangeCharacterEnableState(X0_4, Enabled);
    ForceAnimationPlayback(X0_4, 1701, false, true, false, 0, 1);
    CreateReferredDamagePair(3000804, 3000802);
    CreateReferredDamagePair(3000803, 3000802);
    DisplayBossHealthBar(Enabled, 3000804, 1, 901284);
    DisplayBossHealthBar(Enabled, 3000803, 2, 901285);
    WaitFor(EventFlag(13000989));
    ForceCharacterDeath(X0_4, false);
});

$Event(13009992, Restart, function(X0_4) {
    DeactivateObject(X0_4, Disabled);
    DeleteObjectfollowingSFX(X0_4, true);
    EndIf(EventFlag(13000989));
    if (!EventFlag(13005982)) {
        WaitFor(EventFlag(13005980));
        SpawnOneshotSFX(TargetEntityType.Character, 3000705, 400, 652501);
        IssueShortWarpRequest(10000, TargetEntityType.Area, 3002893, -1);
        SpawnOneshotSFX(TargetEntityType.Character, 10000, 236, 652501);
        ForceAnimationPlayback(10000, 63010, false, true, false, 0, 1);
        WaitFor(EventFlag(13005983));
    } else {
L0:
        WaitFor(EventFlag(13005980) && EventFlag(13005983));
    }
    DeactivateObject(X0_4, Enabled);
    CreateObjectfollowingSFX(X0_4, 101, 662400);
    WaitFor(EventFlag(13000989));
    DeactivateObject(X0_4, Disabled);
    DeleteObjectfollowingSFX(X0_4, true);
});

$Event(13009991, Restart, function() {
    EndEvent();
    EndIf(EventFlag(13000989));
    WaitFor(EventFlag(13000989) || HPRatio(3000804) <= 0.05);
    SetCharacterAIState(3000804, Disabled);
    ForceAnimationPlayback(3000804, 1702, false, true, false, 0, 1);
    WaitFixedTimeSeconds(0.5);
    ChangeCharacterEnableState(3000804, Disabled);
    SetCharacterAnimationState(3000804, Disabled);
});

$Event(13009990, Restart, function() {
    EndEvent();
    EndIf(EventFlag(13000989));
    WaitFor(EventFlag(13000989) || HPRatio(3000803) <= 0.05);
    SetCharacterAIState(3000803, Disabled);
    ForceAnimationPlayback(3000803, 1702, false, true, false, 0, 1);
    WaitFixedTimeSeconds(0.5);
    ChangeCharacterEnableState(3000803, Disabled);
    SetCharacterAnimationState(3000803, Disabled);
});

$Event(13009989, Restart, function() {
    EndIf(EventFlag(13000989));
    WaitFor(EventFlag(13005980));
    WaitFixedTimeSeconds(7);
    SpawnOneshotSFX(TargetEntityType.Character, 3000802, 203, 652500);
    IssueShortWarpRequest(3000802, TargetEntityType.Area, 3002897, -1);
    WaitFixedTimeSeconds(0.1);
    SpawnOneshotSFX(TargetEntityType.Character, 3000802, 203, 652500);
    WaitFixedTimeSeconds(2);
    SetEventFlag(13005983, ON);
});

$Event(13009988, Restart, function() {
    EndIf(EventFlag(13000989));
    EndIf(EventFlag(13005982));
    SetCharacterAIState(3000805, Disabled);
    ForceAnimationPlayback(3000805, 704, true, false, false, 0, 1);
    WaitFor(
        EventFlag(13005980)
            || EntityInRadiusOfEntity(10000, 3000805, 3, 1)
            || CharacterDamagedBy(3000805, 10000));
    ForceAnimationPlayback(3000805, 1704, false, true, false, 0, 1);
    SetCharacterAIState(3000805, Enabled);
    RequestCharacterAIReplan(3000805);
});

$Event(13009975, Restart, function() {
    WaitFor(CharacterDead(3000705));
    ForceCharacterDeath(3000802, false);
});

$Event(13009980, Restart, function() {
    if (ThisEventSlot()) {
        ChangeCharacterEnableState(3000419, Disabled);
        ChangeCharacterEnableState(3000424, Disabled);
        ChangeCharacterEnableState(3000496, Disabled);
        ChangeCharacterEnableState(3000425, Disabled);
        ForceCharacterDeath(3000419, false);
        ForceCharacterDeath(3000424, false);
        ForceCharacterDeath(3000496, false);
        ForceCharacterDeath(3000425, false);
    }
L0:
    ChangeCharacterEnableState(3000955, Disabled);
    WaitFor(CharacterDead(3000419));
    ChangeCharacterEnableState(3000955, Enabled);
});
...
$Event(13000360, Default, function() {
    ...
    CreateObjectfollowingSFX(3001705, 90, 830095);
    SetEventFlag(13000360, ON);
    WaitFixedTimeSeconds(10);
    DeleteObjectfollowingSFX(3001705, true);
});
...
$Event(13005025, Restart, function() {
    EndIf(ThisEventSlot());
    ForceAnimationPlayback(3000404, 703, true, false, false, 0, 1);
    SetCharacterAIState(3000404, Disabled);
    WaitFor(ObjectDestroyed(3001250) || CharacterDamagedBy(3000404, 10000));
    obj = ObjectDestroyed(3001250);
    if (!CharacterDamagedBy(3000404, 10000)) {
        ForceAnimationPlayback(3000404, 1703, false, true, false, 0, 1);
        SetCharacterAIState(3000404, Enabled);
    }
});
...
$Event(13005240, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4, X24_4, X28_4, X32_4, X36_4, X40_4, X44_4) {
    EndIf(ThisEventSlot());
    WaitFixedTimeSeconds(1);
    WaitFor(
        (HasDamageType(X12_4, 10000, DamageType.Unspecified)
            ...
            || HasDamageType(X24_4, 10000, DamageType.Unspecified)
            || HasDamageType(X28_4, 10000, DamageType.Unspecified)
            || HasDamageType(X32_4, 10000, DamageType.Unspecified)
            || HasDamageType(X36_4, 10000, DamageType.Unspecified)
            || HasDamageType(X40_4, 10000, DamageType.Unspecified)
            || HasDamageType(X44_4, 10000, DamageType.Unspecified))
            || EntityInRadiusOfEntity(X0_4, 10000, 1, 1)
            || (CharacterAIState(3000255, AIStateType.Combat)
                && EntityInRadiusOfEntity(3000255, X0_4, 3.5, 1))
            || (CharacterAIState(3000520, AIStateType.Combat)
                && EntityInRadiusOfEntity(3000520, X0_4, 3.5, 1))
            || (CharacterAIState(3000253, AIStateType.Combat)
                && EntityInRadiusOfEntity(3000253, X0_4, 3.5, 1))
            || (CharacterAIState(3000242, AIStateType.Combat)
                && EntityInRadiusOfEntity(3000242, X0_4, 3.5, 1))
            || (CharacterAIState(3000245, AIStateType.Combat)
                && EntityInRadiusOfEntity(3000245, X0_4, 3.5, 1))
            || (CharacterAIState(3005503, AIStateType.Combat, ComparisonType.GreaterOrEqual, 1)
                && EntityInRadiusOfEntity(10000, X0_4, 3.5, 1)));
    WaitFixedTimeSeconds(X8_4);
    if (CharacterHasSpEffect(X0_4, 5450)) {
        ForceAnimationPlayback(X0_4, X4_4, false, false, false, 0, 1);
...
$Event(13005391, Restart, function() {
    ...
    ForceAnimationPlayback(3000190, 91030, false, false, false, 0, 1);
    WaitFixedTimeSeconds(2);
    ...
    if (!EventFlag(13000480)) {
        ...
        WaitFor(
            ((CharacterType(10000, TargetType.BlackPhantom) && CharacterHasSpEffect(10000, 3710))
                ...
                && (CharacterHasSpEffect(3000850, 11000) && CharacterHasSpEffect(3000850, 11001)));
        ClearSpEffect(3000850, 11000);
...
$Event(13005550, Restart, function() {
    EndIf(PlayerIsNotInOwnWorld());
    WaitFor(ActionButtonInArea(3001810, 3001650));
...
$Event(13005560, Restart, function() {
    if (!EventFlag(711)) {
        ...
        DeactivateObject(3001874, Disabled);
        DeactivateObject(3001871, Enabled);
        DeactivateObject(3001873, Enabled);
        WaitFor(EventFlag(711));
    }
L0:
    DeactivateObject(3001872, Enabled);
    DeactivateObject(3001874, Enabled);
    DeactivateObject(3001871, Disabled);
    DeactivateObject(3001873, Disabled);
});
...
$Event(13005812, Restart, function() {
    if (!EventFlag(13000800)) {
        ...
        WaitFixedTimeSeconds(2);
        ForceAnimationPlayback(3001815, 1, false, false, true, 0, 1);
        WaitFixedTimeSeconds(7.5);
        CreateObjectfollowingSFX(3001815, 100, 830101);
        EndEvent();
    }
L0:
    ForceAnimationPlayback(3001815, 2, true, false, false, 0, 1);
    CreateObjectfollowingSFX(3001815, 100, 830101);
});
...
$Event(13005820, Restart, function() {
    ...
    InitializeCommonEvent(20005810, 13000825, 3001800, 3002800, 10000);
});
...
Event(13005830, Restart, function() {
    SetCharacterAIState(3000830, Disabled);
    ...
    SetObjactState(3001813, 300371, Disabled, $LAYERS(0, 1, 2, 3, 4, 5, 6, 7, 8));
...
$Event(13005831, Default, function() {
    ...
    WaitFixedTimeFrames(1);
    SetObjactState(3001813, 300371, Enabled);
    ChangeCamera(-1, -1);
});
...
$Event(13005837, Restart, function() {
    EndIf(EventFlag(13000830));
    WaitFor(CharacterHasEventMessage(3000830, 20));
    CreateNPCPart(3000830, 10, NPCPartType.Part6, 193, 1, 1, false, false);
});
...
$Event(13005840, Restart, function() {
    ...
    InitializeCommonEvent(20005820, 13000890, 3001891, 3, 0);
});

$Event(13005850, Restart, function() {
    EndIf(EventFlag(13000830));
    SetNetworkSyncState(Disabled);
    WaitFor(InArea(10000, 3002850));
    EndIf(EventFlag(13000830));
...
Event(13005880, Restart, function() {
    ...
    ForceAnimationPlayback(3001087, 0, true, false, false, 0, 1, $LAYERS(0, 1, 2, 3, 4, 5, 6, 7, 8));
    DeactivateObject(3001870, Disabled, $LAYERS(0, 1, 2, 3, 4, 5, 6, 7, 8));
    EndIfPlayerIsNotInOwnWorldExcludesArena(EventEndType.End, true);
    IfEventFlag(MAIN, ON, TargetEventFlagType.EventFlag, 13000890, $LAYERS(0, 1, 2, 3, 4, 5, 6, 7, 8));
    IfActionButtonInArea(MAIN, 3001895, 3001896, $LAYERS(0, 1, 2, 3, 4, 5, 6, 7, 8));
    SkipIfMultiplayerState(2, MultiplayerState.TryingtoCreateSession, $LAYERS(0, 1, 2, 3, 4, 5, 6, 7, 8));
    ...
    Label0();
    ForceAnimationPlayback(3001087, 10, true, false, false, 0, 1, $LAYERS(0, 1, 2, 3, 4, 5, 6, 7, 8));
    DeactivateObject(3001870, Enabled, $LAYERS(0, 1, 2, 3, 4, 5, 6, 7, 8));
    RegisterLadder(13000264, 13000265, 3001087, $LAYERS(0, 1, 2, 3, 4, 5, 6, 7, 8));
    ForceAnimationPlayback(3001896, 2, true, false, false, 0, 1, $LAYERS(0, 1, 2, 3, 4, 5, 6, 7, 8));
...
$Event(13005890, Restart, function() {
    ...
    if (!EventFlag(13000896)) {
        ...
        WaitFor(
            CharacterDead(3000705)
                && PlayerHasItem(ItemType.Goods, 2117)
                && InArea(10000, 3002700)
                && EventFlag(13000989));
        if (NumberOfClientsOfType(ClientType.Invader) != 0) {
            SendInvadingPhantomsHome(0);
        }
...
$Event(13005892, Restart, function() {
    EndIf(EventFlag(13000890));
    CreateNPCPart(3000899, 10, NPCPartType.Part5, 400, 1, 1, false, false);
...
$Event(13005893, Default, function() {
    ...
    if (!EventFlag(13005894)) {
        ForceAnimationPlayback(3001895, 2, false, false, false, 0, 1);
    } else {
L0:
        ForceAnimationPlayback(3001895, 0, false, false, false, 0, 1);
    }
L1:
    WaitFor(EventFlag(13005885));
    WaitFor(
        CharacterType(10000, TargetType.WhitePhantom)
            && !EventFlag(13000890)
            && ActionButtonInArea(3001890, 3001890));
    RotateCharacter(10000, 3002896, 60060, true);
    EnableBossMapSound(3002899, Enabled);
    DisplayBossHealthBar(Enabled, 3000899, 0, 905270);
    SetNetworkUpdateRate(3000899, true, CharacterUpdateFrequency.AlwaysUpdate);
...
$Event(13005895, Restart, function() {
    ...
    if (!EventFlag(13000880)) {
        ForceAnimationPlayback(3001895, 1, false, true, false, 0, 1);
        ForceAnimationPlayback(3001895, 2, false, false, false, 0, 1);
    }
});
